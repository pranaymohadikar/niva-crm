...
class Patient(Base):
    ...
    alt_number = Column(Text)
    condition_type = Column(String(100))
    plan_purchase_date = Column(Text)
    plan_duration = Column(Text)
    plan_price = Column(Text)
    ...
    mode_of_payment = Column(Text)
    rm_call_booked = Column(Text)
    sales_remarks = Column(Text)
    payment_month = Column(Text)
    week_no = Column(Text)
    created_at = Column(DateTime, default=now_ist)
...
class RMData(Base):
    ...
    welcome_call_booked_timestamp = Column(Text)
    welcome_call_done = Column(Text)
    welcome_call_completion_date = Column(Text)
    welcome_call_booked_not_completed = Column(Text)
    metabolic_assessment = Column(Text)
    ...
    cs_call_date = Column(Text)
    cs_call_time = Column(Text)
...
class MonthlyCycle(Base):
    ...
    assessment_done = Column(Text)
    assessment_date = Column(Text)
    plan_assigned = Column(Text)
    plan_date = Column(Text)
    plan_comments = Column(Text)
    exercise_plan_assigned = Column(Text)
    exercise_plan_date = Column(Text)
    exercise_plan_comments = Column(Text)
    followup_done = Column(Text)
    followup_date = Column(Text)
